...
Adds the ability for users to vote on a topic using Twitter.
Display the results in standard banner sizes on any post page or with a widget. 
...
Create your own topics on [Upvoting.com](http://upvoting.com "Visit Upvoting.com")
