...
- The voteid id the number that appears on the voting page (look near the bottom) or in the authverify tweet.
...
Q: Can I add the banner without using shortcode, like a form or something?
A: Not yet, this feature will be added soon. 
