...
function udv_optionsMenuSection_headCallback() {
	...
	echo '<p>Create your own topics on <a href="http://upvoting.com/create/">Upvoting.com</a></p>';
	echo '<p>For Developer Resources including sample banner sizes and a list of trending topics visit <a href="http://upvoting.net/">Upvoting.net</a></p>';
